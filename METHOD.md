...
|---|---|---|---|---|
| **1** | **Plan** | an interview that sharpens the idea into shared understanding and leaves a record | **invoke NOW** `prisma-plan`, which closes by declaring the lane and whether the work fits in one session | the agent starts it; the person answers decisions |

...
| Data to a third party | Does a file, list or figure leave to someone else? | the producing query is code and runs its lane, plus step 3 on the real rows, plus a refuter |

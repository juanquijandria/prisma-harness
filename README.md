...
| no push from a watched repository carries comment lines, figures in comments or file and line references | hook | the comments gate blocks HEAD or says it measured nothing, and an escape is recorded in the receipt |

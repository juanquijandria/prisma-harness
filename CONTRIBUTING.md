...
- **English** in code, messages, file names and commits. Spanish belongs under `docs/es/`. One file is still pending, `hooks/measure-comments.sh` keeps Spanish identifiers from the toolbox it was ported from, and they get translated when that file is next opened.

...
| 1c | solo si NO cabe | escribir el destino y el camino en tickets del tamaño de una sesión | spec y tickets del tamaño de una sesión (la persona, directo, `/to-spec` → `/to-tickets`) | el agente |

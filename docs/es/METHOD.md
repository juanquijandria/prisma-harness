...
| **2** | **Construir** | ejecutar la cadena de construcción | **invoca AHORA** `prisma-build`, que escribe cada prueba y la ve en rojo antes de que exista el código, la pone en verde, lanza `prisma-fidelity-review` en un subagente limpio y hace commit | el agente |

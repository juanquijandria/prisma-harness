...
| **Datos a un tercero** | un archivo, una lista o una cifra que alguien más va a usar | **suma controles, no los reemplaza.** La consulta que produce el archivo es código y corre por su carril; la entrega lleva además **paso 3 obligatorio**, abrir el archivo y mirar filas reales, el protocolo de verificación y refutador |

...
- Every deciding hook has a `--selftest` or a control script under `tests/`. Run `tests/run-selftests.sh` before and after a change; a gate whose tests never fail is decoration.
